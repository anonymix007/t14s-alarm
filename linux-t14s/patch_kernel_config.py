...
# inputfile = "/home/user/src/git/t14s-alarm/linux-t14s/config"
...
for line in new_lines:
    if isinstance(line, tuple):
        key, value = line
        if key in t14s_options:
            if value != t14s_options[key]:
                output_lines.append(f"{key}={t14s_options[key]}\n")
            else:
...
for extra_config in leftovers:
    output_lines.append(f"{extra_config}={t14s_options[extra_config]}\n")
